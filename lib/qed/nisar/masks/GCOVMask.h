...
// map a GCOV mask value to a color
...
public:
    ...
    // metamethods
public:
    inline GCOVMask(source_const_reference data);
...
public:
    ...
    // constructors
    GCOVMask(const GCOVMask &) = default;
    GCOVMask(GCOVMask &&) = default;
    GCOVMask & operator=(const GCOVMask &) = default;
    GCOVMask & operator=(GCOVMask &&) = default;
};


// the definitions
#include "GCOVMask.icc"
