...
// code guard
#if !defined(qed_nisar_channels_imaginary_h)
#define qed_nisar_channels_imaginary_h
...
#define qed_nisar_channels_imaginary_icc
#include "imaginary.icc"
#undef qed_nisar_channels_imaginary_icc
