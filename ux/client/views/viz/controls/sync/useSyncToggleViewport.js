...
export const useSyncToggleViewportMutation = graphql`
    mutation useSyncToggleViewportMutation($input: ViewSyncToggleViewportInput!) {
        viewSyncToggleViewport(input: $input) {
            view {
                channel {
                    tag
                }
