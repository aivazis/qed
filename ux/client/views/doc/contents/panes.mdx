...
The same procedure will work regardless of how many times you have split the data panes. Each one
...
data panes that have opted in. Finally, if both datasets offer the same set of channels, you
