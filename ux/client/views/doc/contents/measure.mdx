...
As mentioned above, points can be dismissed by clicking on the <Badge><X/></Badge> icons on the table.
Points can be added in the middle of the path by clicking on the <Badge><Plus/></Badge> icon on the
table. This action places a new point midway between the selected point and the one that follows it.
