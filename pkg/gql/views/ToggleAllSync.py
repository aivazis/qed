...
class ToggleAllSync(graphene.Mutation):
    """
    ...
    sync = graphene.List(Sync)

    # the range controller mutator
    @staticmethod
    def mutate(root, info, viewport, reader, aspect):
        """
        ...
        sync = store.setSync(viewport=viewport, aspect=aspect)
