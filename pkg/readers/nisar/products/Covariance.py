...
class Covariance(Product, family="qed.datasets.nisar.products.covariance"):
    """
    An UNW dataset
    """
    ...
    def peek(self, pixel):
        ...
        covariance = channels["covariance"]
        # project
        yield "covariance", covariance.project(pixel=value)
        # all done
        return
